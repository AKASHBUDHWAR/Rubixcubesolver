...
class RubiksCubeBitboard: public RubiksCube {
    ...
    void rotateFace(int ind) {
        uint64_t temp = bitboard[ind]>>48;
        bitboard[ind] = bitboard[ind]<<16;
        bitboard[ind]=bitboard[ind]|temp;
    ...
    COLOR getColor(FACE face, unsigned row, unsigned col) const override {
        int num=arr[row][col];
        if (num==8) return COLOR(static_cast<int>(face));
        uint64_t c=bitboard[static_cast<int>(face)];
        uint64_t b=(c>>(8*num))&one_8;
      int  bitspos=0;
        while (b!=0) {
            b=b>>1;
            bitspos++;
    ...
    RubiksCube &u() override {
        this->rotateFace(0);
        uint64_t clr1=(bitboard[1]&(one_8<<(8 * 0)))>>(8*0);
        uint64_t clr2=(bitboard[1]&(one_8<<(8 * 1)))>>(8*1);
...
RubiksCube &u2() override {
    ...
    RubiksCube &d() override {
        this->rotateFace(5);
        uint64_t clr1=(bitboard[4]&(one_8<<(8 * 4)))>>(8*4);
        uint64_t clr2=(bitboard[4]&(one_8<<(8 * 5)))>>(8*5);
        uint64_t clr3=(bitboard[4]&(one_8<<(8 * 6)))>>(8*6);
        this->rotateSide(4,4,5,6,3,4,5,6);
        this->rotateSide(3,4,5,6,2,4,5,6);
        this->rotateSide(2,4,5,6,1,4,5,6);
        bitboard[1]=(bitboard[1]&~(one_8<<(8 * 4)))|(clr1<<(8*4));
        bitboard[1]=(bitboard[1]&~(one_8<<(8 * 5)))|(clr2<<(8*5));
    ...
    RubiksCube &l() override {
        ...
        this->rotateSide(5,6,7,0,2,6,7,0);
        bitboard[2]=(bitboard[2]&~(one_8<<(8 * 0)))|(clr1<<(8*0));
        bitboard[2]=bitboard[2]&~(one_8<<(8 * 7))|(clr2<<(8*7));
        bitboard[2]=bitboard[2]&~(one_8<<(8 * 6))|(clr3<<(8*6));
        return *this;
    }
